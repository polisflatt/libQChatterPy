...
class QChatterChannel:
    ...
    def __init__(self, _channel, _quser, password = ""):
    ...
    def sendMessage(self, message):
        post_parameters = {"channel": self.channel, "title": self.quser.username, "content": message, "user_password": self.quser.password}
